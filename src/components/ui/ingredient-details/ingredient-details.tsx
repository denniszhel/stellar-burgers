...
type TIngredientDetailsUIPropsWithShowHeader = IngredientDetailsUIProps & {
  showHeader: boolean;
};

export const IngredientDetailsUI: FC<TIngredientDetailsUIPropsWithShowHeader> =
  memo(({ ingredientData, showHeader }) => {
